...
- define what global challenges are
...
{{% content-video src="videos/igem/explainer-01.mp4" class="wide" %}}
...
<div class="image-grid three-col">
{{% content-video src="videos/igem/content-video-00.mp4" %}}
{{% content-video src="videos/igem/content-video-01.mp4" %}}
{{% content-video src="videos/igem/content-video-02.mp4" %}}
</div>
...
<div class="image-grid three-col">
{{% content-video src="videos/igem/content-video-03.mp4" %}}
{{% content-video src="videos/igem/content-video-04.mp4" %}}
{{% content-video src="videos/igem/content-video-05.mp4" %}}
</div>
...
I came up with the idea for this video when the Award Show exclusively featured [explainer videos](#explainer-videos). **This video introduced the broader vision of synthetic biology**: a field that applies engineering principles to genetic engineering and has the potential to transform manufacturing, medicine, agriculture, and sustainability.
