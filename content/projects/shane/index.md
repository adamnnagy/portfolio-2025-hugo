...
{{% image src="images/shane/shane-02.jpg" alt="A screenshot from the VR experience" class="content-image" %}}
...
{{% image src="images/shane/shane-05.jpg" alt="A screenshot from the VR experience" class="content-image" %}}
{{% image src="images/shane/shane-04.jpg" alt="A screenshot from the VR experience" class="content-image" %}}
</div>
...
<div class="image-grid two-col">
{{% image src="images/shane/shane-01.jpg" alt="A screenshot from the VR experience" class="content-image" %}}
