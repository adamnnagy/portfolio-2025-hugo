...
[] Project: iGEM: Shorten
[] add (hover) animations to titles / headers if possible 
[] style: full width for youtube videos and other blocks / make classes so they can be dynamic
[] Content: 
[] Design: project pages main text too white / too much contrast
[] Design: project pages main text too small (weird?)
...
[] Design: Titles - remove uppercase
[] Design: iGEM TOC looks like shit
[] Design: lists appear weirdly
[] Design: 
