...
{{% image src="images/puppet-gene/puppet-gene-03.jpg" alt="placeholder" class="content-image" %}}
...
{{% image src="images/puppet-gene/puppet-gene-02.jpg" alt="placeholder" class="content-image" %}}

<div class="image-grid three-col">
{{% image src="images/puppet-gene/puppet-gene-06.jpg" alt="placeholder" class="content-image" %}}
{{% image src="images/puppet-gene/puppet-gene-04.jpg" alt="placeholder" class="content-image" %}}
